...
const GPlus = ({ Enter, Leave, mobile }) => {
  return (
    <div
    ...
    >
      ...
      >
        <div className="flex flex-col gap-2  w-full overflow-auto">
          {mobiles[0].G_Plus.map((item, index) => (
            <span
              key={index}
          ...
          <div className="flex justify-center p-9 bg-white rounded-lg hover:bg-gray-200 transition-all ease-in duration-300">
