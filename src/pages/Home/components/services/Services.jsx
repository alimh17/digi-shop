  ...
  return (
    <section className="flex justify-center  md:mt-6 mt-6 md:py-10">
      <figure className="hidden md:flex">
        <div className="container  gap-5  md:grid grid-cols-2 grid-rows-2  lg:flex ">
          <div className=" flex justify-center items-center bg-gray-100 border  rounded-lg lg:w-1/4">
            <p className="md:text-2xl text-gray-500">تحویل سریع و ارزان</p>
            <span className="mx-3">
          ...
          <div className=" flex justify-center items-center bg-gray-100 border  rounded-lg lg:w-1/4">
            <p className="md:text-2xl text-gray-500">پرداخت درب منزل</p>
            <span className="mx-3">
          ...
          <div className=" flex justify-center items-center bg-gray-100 border  rounded-lg lg:w-1/4">
            <p className="md:text-2xl text-gray-500">پشتیبانی 24/7</p>
            <span className="mx-3">
          ...
          <div className=" flex justify-center items-center bg-gray-100 border  rounded-lg lg:w-1/4">
            <p className="md:text-2xl text-gray-500">ضمانت 3 روز بازگشت کالا</p>
            <span className="mx-3">
